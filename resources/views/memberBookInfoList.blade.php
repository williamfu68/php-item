...
<body>
        <p></p>
        <h3 style = "text-align: center;color:#515a6e">会员预订信息</h3>
        <p></p>
        <div id = "hint" style = "display: none">
            <p style = "display: inline-block;margin-left:7px;">已选择 {{$reasult->count()}} 条数据</p>
            <a href="{{url('/cancelAllMemberBookInfo')}}">
        ...
        <table class='table table-bordered table-hover table-md text-center'>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href='{{url("/cancelMemberBookInfo?id=$res->id")}}'><button class = "btn btn-outline-danger btn-sm">删除</button></a></td>
                </tr>
                @endforeach
            </tbody>
        </table>
