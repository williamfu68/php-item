...
<head>
    ...
    <body> 
        <div class="banner">
            <p id = "logo">
                <a style = "text-decoration:none;color:#f0f0f0" href = "javascript:;">Brand Logo</a>
            </p>
            <p class = "font-weight-normal text-monospace" id = "title">酒店信息管理系统</p>
            <button type = "button" class = "btn btn-outline-primary"><a href = "{{url('/register')}}" style = "text-decoration: none;color:white">Sign Up</a></button>
        </div>
        <div class='login'>
                <ul class="topUl">
                    <li style = "background-color:#007bff">前台登录</li>
                    <li>管理员登录</li>
                </ul>
                <ul class="bottomUl">
                    <li>
                        <div style = "position:relative;padding-top:5px;">
                            <form action="{{url('/userCheck')}}" method = "post" autocomplete="off" class="needs-validation" novalidate>
                                @csrf
                                <div class="form-group">
                                    ...
                                    <label for="pwd" style = "text-indent: 20px">密码 :</label>
                                    ...
                                    <label for="captcha" style = "text-indent: 20px">验证码 :</label>
                                    ...
                                    <a href="/userResetPassword" id = "forgetPwd"><small class = "text-muted">重置用户</small></a>
                                    <small class = "text-muted"><span id = "hint1"></span></small>
                                    <img src="" id = "img1">
                                    <p style = "text-align:center;margin-top:18px;"><button type = "submit" class = "btn btn-outline-primary"  style = "width:50%" id = "btn1">登录</button></p>         
                                </div>
                            </form>
                        </div>
                    </li>
                    <li>
                        <div style = "position:relative;padding-top:5px;">
                            <form action="{{url('/adminCheck')}}" method = "post" autocomplete="off" class="needs-validation" novalidate>
                                @csrf
                                <div class="form-group">
                                    <label for="userName">用户名:</label>
                                    <small class = "text-muted">用户名长度4-16位，可以包含大小写字母、数字、汉字和英文下划线</small>
                                    ...
                                    <input type="text" name="captcha" id="captchaInput2" class = "form-control  form-control-sm" style = "width:35%;margin-left:50px" value = "{{old('captcha')}}" required > 
                                    
                                    <a href="javascript:;" id = "anchor2"><small class = "text-muted">看不清?点我</small></a>
                                    <a href="/adminResetPassword" id = "forgetPwd"><small class = "text-muted">重置用户</small></a>
                                    <small class = "text-muted"><span id = "hint2"></span> </small>
                                    <img src="" id = "img2">
                                    <p style = "text-align:center;margin-top:18px;"><button type = "submit" class = "btn btn-outline-primary"  style = "width:50%" id = "btn2">登录</button></p>         
                                </div>
                            </form>
                        </div>
                    </li>
            ...
            <div class="container_fluid" id = "footer">
                <p class = "text-center text-light">Copyright &copy; 2020 ABC.Co.Ltd. All Rights Reserved.</p>
            </div>
