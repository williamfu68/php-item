...
<head>
    ...
    <body> 
        <div class="banner">
            ...
            <button type = "button" class = "btn btn-outline-primary"><a href = "{{url('/login')}}" style = "text-decoration: none;color:white">Sign In</a></button>
        </div>
        <div class='login' style = "height: 495px">
                <ul class="topUl">
                    <li style = "background-color:#007bff">前台注册</li>
                    <li>管理员注册</li>
                </ul>
                <ul class="bottomUl">
                    <li>
                        <div style = "position:relative;padding-top:5px;height:455px">
                            <form action="{{url('/register/users')}}" method = "post" autocomplete="off" class="needs-validation" novalidate>
                                @csrf
                                <div class="form-group">
                                    ...
                                    <svg class="bi bi-eye-slash" width="1em" height=".9em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style = "position: absolute;top:108px;">
                                      ...
                                      <svg class="bi bi-eye" width="1em" height=".9em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style = "display: none;position: absolute;top:108px">
                    ...
                    <li>
                        <div style = "position:relative;padding-top:5px;height:455px">
                            <form action="{{url('/register/admins')}}" method = "post" autocomplete="off" class="needs-validation" novalidate>
                                @csrf
                                <div class="form-group">
                                    <label for="userName">用户名:</label>
                                    <small class = "text-muted">用户名长度4-16位，可以包含大小写字母、数字、汉字和英文下划线</small>
