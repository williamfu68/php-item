...
<head>
    ...
    <script>
        $(function() {
                ...
                var flag = true;
                $('.main>.sixth svg').on('click',function() {
                        if(flag == true) {
...
<body>
    ...
    <div class="banner">
        ...
        <p class = "font-weight-normal text-monospace" id = "hint">欢迎您，前台{{session('currentUser')}}</p>
        <p class = "font-weight-normal text-monospace" id = "time"></p>
        <p class = "font-weight-normal text-monospace"><a href="/userForgetPassword" id = "link">修改密码</a></p>
    ...
    <ul class="left">
        ...
        <li><i class="fa fa-file-text-o"></i>
            <span>账户信息管理</span>
            <ul class="submenu">
                <li><a href='{{url("/queryUserPersonalInfo")}}' style = "text-decoration:none;color:#adbcdb;">我的账户信息</a></li>
                <li>修改账户信息</li>
            </ul>
        </li>
        <li>
    ...
    <div class="main">
        <ul class = "first">
            <li>
                <div>
                    <br>
                    <h3 style = "text-align: center">客户信息添加</h3>
                    <form action="{{url('/addCustomerInfo')}}" autocomplete="off" style = "margin:0 10px;">
            ...
            <li>
                <div>
                    <br>
                    <h3 style = "text-align: center">客户信息查询</h3>
                    <br>
                    <form action="{{url('/queryCustomerInfo')}}" autocomplete="off" style = "margin:0 10px;">
                        <label for="name">客户姓名：</label>
                        <input type="text" class = "form-control form-control-sm" name = "name" id = "name" required>
                        <br>
                       <button type = "reset" class = "btn btn-sm btn-outline-danger" style = "position:absolute;left:30%;width:150px;">重置</button>
                       <button type = "submit" class = "btn btn-sm btn-outline-primary" style = "position:absolute;right:30%;width:150px;">查询</button>
                    </form>
                </div>
            </li>
            ...
            <li>
                <div>
                    <br>
                    <h3 style = "text-align: center">更新退房时间</h3>
                    <br>
                    <form action="{{url('/updateCheckOutTime')}}" autocomplete="off" style = "margin:0 10px;">
                        <label for="name3">客户姓名：</label>
                        <input type="text" class = "form-control form-control-sm" name = "name" id = "name3" required>

                        <label for="checkOutTime2">退房时间：</label>
                        <input type="datetime-local" class = "form-control form-control-sm" name = "checkOutTime" id = "checkOutTime2" required>
                        <br>
                       <button type = "reset" class = "btn btn-sm btn-outline-danger" style = "position:absolute;left:30%;width:150px;">重置</button>
                       <button type = "submit" class = "btn btn-sm btn-outline-primary" style = "position:absolute;right:30%;width:150px;">更新</button>
                    </form>
                </div>
            </li>
        </ul>
        <ul class = "second">
            <li>
                <div>
                    <br>
                    <h3 style = "text-align: center">会员信息注册</h3>
                    <form action="{{url('/registerMember')}}" autocomplete="off" style = "margin:0 10px;">
                            <label for="name">姓名：</label>
                            <input type="text" class = "form-control form-control-sm" name = "name" id = "name" required>
                            ...
                            <br>
                       <button type = "reset" class = "btn btn-sm btn-outline-danger" style = "position:absolute;left:30%;width:150px;">重置</button>
                       <button type = "submit" class = "btn btn-sm btn-outline-primary" style = "position:absolute;right:30%;width:150px;">注册</button>
                    </form>
                </div>
            </li>
            <li>
                <div>
                    <br>
                    <h3 style = "text-align: center">会员信息查询</h3>
                    <br>
                    <form action="{{url('/queryMemberInfo')}}" autocomplete="off" style = "margin:0 10px;">
        ...
        <ul class = "third">
            <li>
                <div>
                    <form action="{{url('/queryRoomInfo')}}" autocomplete="off" style = "margin:0 10px;">
                            <br>
                            <h3 style = "text-align: center">客房信息查询</h3>
        ...
        <ul class = "fourth">
            <li>
                <div>
                    <p></p>
                    <h3 style = "text-align: center">普通预订</h3>
                    <form action="{{url('/customerBookInfo')}}" autocomplete="off" style = "margin:0 10px;">
                            <label for="name">姓名：</label>
                            <input type="text" class = "form-control form-control-sm" name = "name" id = "name" required>
                            ...
                            <select class = "form-control" name = "roomID" id = "roomID">
                                ...
                                <option value="101">107</option>
                                <option value="102">108</option>
                                <option value="103">109</option>
                                <option value="104">110</option>
                                <option value="105">111</option>
                                <option value="106">112</option>
                            </select>

                            <label for="bookTime">预订时间：</label>
                            <input type="datetime-local" class = "form-control form-control-sm" name = "bookTime" id = "bookTime" required>
                            
                            <label for="checkOutTime">退房时间：</label>
                            <input type="datetime-local" class = "form-control form-control-sm" name = "checkOutTime" id = "checkOutTime" required>
                            <p></p>
                       <button type = "reset" class = "btn btn-sm btn-outline-danger" style = "position:absolute;left:30%;width:150px;">重置</button>
                       <button type = "submit" class = "btn btn-sm btn-outline-primary" style = "position:absolute;right:30%;width:150px;">预订</button>
                    </form>
                </div>
            </li>
            <li>
                <div>
                    <p></p>
                    <h3 style = "text-align: center">会员预订</h3>
                    <form action="{{url('/memberBookInfo')}}" autocomplete="off" style = "margin:0 10px;">
                            <label for="name">姓名：</label>
                            <input type="text" class = "form-control form-control-sm" name = "name" id = "name" required>
            ...
            <li>
                <div>
                    <br>
                    <h3 style = "text-align: center">普通预订查询</h3>
                    <br>
                    <form action="{{url('/queryCustomerBookInfo')}}" autocomplete="off" style = "margin:0 10px;">
                        <label for="name">客户姓名：</label>
                        <input type="text" class = "form-control form-control-sm" name = "name" id = "name" required>
                        <br>
                       <button type = "reset" class = "btn btn-sm btn-outline-danger" style = "position:absolute;left:30%;width:150px;">重置</button>
            ...
            <li>
                <div>
                    <br>
                    <h3 style = "text-align: center">会员预订查询</h3>
                    <br>
                    <form action="{{url('/queryMemberBookInfo')}}" autocomplete="off" style = "margin:0 10px;">
                        <label for="name">会员姓名：</label>
                        <input type="text" class = "form-control form-control-sm" name = "name" id = "name" required>
                        <br>
                       <button type = "reset" class = "btn btn-sm btn-outline-danger" style = "position:absolute;left:30%;width:150px;">重置</button>
        ...
        <ul class="fifth">
            <li>
                <div>
                    <p></p>
                    <h3 style = "text-align: center">添加业务记录</h3>
                    <form action="{{url('/addBusinessRecordInfo')}}" autocomplete="off" style = "margin:0 10px;">
                            <label for="name">姓名：</label>
                            <input type="text" class = "form-control form-control-sm" name = "name" id = "name" required>
                            ...
                            <select class = "form-control" name = "price" id = "price">
                                <option value="100/天">100元/天</option>
                                <option value="200/天">200/天</option>
                                <option value="300/天">300/天</option>
                                <option value="400/天">400/天</option>
                                <option value="500/天">500/天</option>
                                <option value="600/天">600/天</option>
                            </select>
                            ...
                            <input type="text" class = "form-control form-control-sm" name = "totalPrice" id = "totalPrice" required>
                        <p></p>
                       <button type = "reset" class = "btn btn-sm btn-outline-danger" style = "position:absolute;left:30%;width:150px;">重置</button>
                       <button type = "submit" class = "btn btn-sm btn-outline-primary" style = "position:absolute;right:30%;width:150px;">添加</button>
                    </form>
        ...
        <ul class="sixth">
            ...
            <li>
                <div>
                    ...
                    <form action="{{url('/alterUserPersonalInfo')}}" autocomplete="off" style = "margin:0 10px;">
    ...
    <script>
        ...
        var flag = true;
            $('.main>.fifth svg').on('click',function() {
                    if(flag == true) {
                        $(this).hide().siblings('svg').show();
                        $('#pwd').attr('type','text');
